        ...
        <div class="total-assets-box">
          <div class="total-assets">
            <div class="assets-count" @click="$router.push('/finance/generalasset')">
              <div class="count-left">
                <p class="count-title" style="font-size: 20px;">
          ...
          <swiper :options='swiperOption' class="notice-swiper" ref="myswiper" v-if="noticeList.length > 0">
            <swiper-slide v-for="(item,index) in noticeList" :key="index">
              <div class="notice" @click="$router.push('/account/news_detail?id='+item.id)"><img src="../../assets/img/icon/gonggao.png"
                  alt="">
          ...
          <div class="wallet-box">
            ...
            <div class="wallet-item" @click="notDeschide">
              <p class="count-title">
...
<script>
  ...
  export default {
    data() {
      return {
        ...
        developments: [{
          ...
          {
            imgPath: require('../../assets/img/icon/home_icon_13.png'),
            devTitle: this.$t('index.app_13')
          },
          {
    ...
    methods: {
      ...
      // 暂未开通
      notDeschide() {
        this.messagebox("提示", "功能暂未开通，敬请期待！");
      },
    },
    components: {
      MainContainer,
